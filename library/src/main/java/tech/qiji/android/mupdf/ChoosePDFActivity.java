...
public class ChoosePDFActivity extends ListActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mPurpose =
        PICK_KEY_FILE.equals(getIntent().getAction()) ? Purpose.PickKeyFile : Purpose.PickPDF;
    ...
    mUpdateFiles = new Runnable() {
      public void run() {
          ...
          public boolean accept(File file) {
            ...
            switch (mPurpose) {
              case PickPDF:
                ...
                if (fname.endsWith(".epub")) return true;
        ...
        if (mParent != null) {
          adapter.add(
              new ChoosePDFItem(ChoosePDFItem.Type.PARENT, getString(R.string.parent_directory)));
        }
        for (File f : mDirs)
