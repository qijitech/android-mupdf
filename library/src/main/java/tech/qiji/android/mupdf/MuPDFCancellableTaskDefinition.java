...
public abstract class MuPDFCancellableTaskDefinition<Params, Result>
    implements CancellableTaskDefinition<Params, Result> {
  ...
  @Override public void doCleanup() {
    if (cookie == null) return;
  ...
  @Override public final Result doInBackground(Params... params) {
